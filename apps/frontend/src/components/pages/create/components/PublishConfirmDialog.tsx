        ...
        {isOpen ? (
          ...
          >
            ...
            <dl className="mt-4 space-y-3 text-sm">
              ...
              <Row icon={LinkSimpleIcon} label="Ownership">
                <span className="text-ink">
                  {isTransferable ? "Transferable" : "Soulbound"}
                </span>
              </Row>
              ...
              <Row icon={GlobeHemisphereWestIcon} label="Network">
                <span className="text-ink">{SITE.network}</span>
              </Row>
            </dl>

            <p className="mt-4 text-xs leading-relaxed text-ink-muted">
              One transaction registers the name to you, deploys a resolver for
              this index alone and writes every record. The name is yours for a
              year and cannot be registered by anyone else meanwhile.
            </p>
