...
/// ENS records under `ensName` and is read from there; duplicating it in
/// storage would create a second source of truth that can disagree with the
/// name, which is exactly what this protocol is arguing against.
contract IndexVault is ERC20 {
    /// The ENS name that owns the methodology this vault tracks.
